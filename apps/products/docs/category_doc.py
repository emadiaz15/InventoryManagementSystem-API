...
list_category_doc = {
    ...
    'description': 'Recupera una lista paginada de todas las categorías activas. Accesible solo para usuarios autenticados.',
    'tags': ['Categories'],
    'security': [{'jwtAuth': []}],  # Seguridad correctamente definida
    'parameters': [  # Asegúrate de agregar 'parameters'
        {
            'name': 'name',
            'in': 'query',
...
create_category_doc = {
    ...
    'description': 'Crea una nueva categoría. Solo accesible para administradores.',
    'tags': ['Categories'],
    'security': [{'jwtAuth': []}],  # Seguridad correctamente definida
    'requestBody': {
        'required': True,
...
delete_category_by_id_doc = {
    ...
    'description': (
        'Elimina suavemente una categoría específica (soft delete). '
